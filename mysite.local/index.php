...
function drawMenu($menu=[], $vertical='true'){
  ...
  foreach($menu as $link=>$href){
    if($vertical == true){
    echo "<li style='display:block'><a href=\"$href\">$link</a></li>";
    }else{
    echo "<li style='display:inline; margin:0 5px 0 0;'><a href=\"$href\">$link</a></li>";
    }
...
<body>
  ...
  <div id="header">
    ...
    <img src="куук.png" width="187" height="29" alt="Наш логотип" class="logo" />
